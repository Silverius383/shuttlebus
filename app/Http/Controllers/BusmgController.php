...
class BusmgController extends Controller
{
    /**
    ...
    {
        return view('manager.buses.add-bus');
    }
    ...
    {
        // $bus = Bus::find($id);
        // return view('manager.buses.bus-view', compact( 'bus'));
    }
    ...
    {
        $bus = Bus::find($id);
        return view('manager.buses.edit-bus', compact('bus'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/manager/bus');//->with('success', 'Bus Deleted Successfully');
    }
}