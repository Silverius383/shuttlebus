...
class StationmgController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('manager.stations.add-station', compact('stations'));
    }
    ...
    public function show($id)
    {
        ...
        return view('manager.stations.station-view', compact('station'));
    }
    ...
    {
        $station = Station::find($id);
        return view('manager.station.edit-station', compact('station'));
    }
